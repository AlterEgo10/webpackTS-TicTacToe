...
//import { IsActive } from 'types/global';
...
interface SidebarProps {
  isActive: IsActive; // Определяем интерфейс SidebarProps, который содержит свойство isActive типа IsActive
}
        ...
        >
          <Nav.Item>
            <Nav.Link
              ...
              // }
               className={`text-light ${isActive ? 'active' : ''}`}
            >
              <IoHomeOutline
                size="16"
                className="me-2"
          ...
          <Nav.Item>
            <Nav.Link
              ...
              // className={({ isActive }) => `text-light ${isActive ? 'active' : ''}`}
            >
